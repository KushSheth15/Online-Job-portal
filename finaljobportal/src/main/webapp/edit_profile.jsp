<%-- 
    ...
    Created on : 22-May-2023, 5:55:24 pm
    Author     : KUSH
--%>
                    ...
                    <div class="card-body">
                        ...
                        <form action="update_profile" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" required="required" class="form-control" id="exampleInputEmail1"
                                       aria-describedby="emailHelp" name="ps" value="${userobj.password}">
                            </div>
                            <div class="form-group">
                                <label>Enter Mobile no</label>
                                <input type="text" required="required" class="form-control" id="exampleInputEmail1"
                                       aria-describedby="emailHelp" name="mobile" value="${userobj.mobileno}">
                            </div>
